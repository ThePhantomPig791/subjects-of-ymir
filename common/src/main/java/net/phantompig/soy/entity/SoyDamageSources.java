...
public class SoyDamageSources {
    ...
    public static final ResourceKey<DamageType> EAT = ResourceKey.create(Registries.DAMAGE_TYPE, SubjectsOfYmir.rsrc("eat"));
    ...
    public static DamageSource eat(Level level, Entity attacker) {
        return new DamageSource(
                level.registryAccess()
                        .lookupOrThrow(Registries.DAMAGE_TYPE)
                        .get(EAT).get(),
