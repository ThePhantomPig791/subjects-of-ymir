...
public class RenderingUtil {
    public static void renderSphere(PoseStack poseStack, MultiBufferSource bufferSource, float radius, float r, float g, float b, float alpha, float latLines, float longLines) {
        poseStack.pushPose();
