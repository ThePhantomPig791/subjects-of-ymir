...
public class OdmBladesRightTextureVariable implements ITextureVariable {
    @Override
    public Object get(DataContext context) {
        if (context.getEntity() instanceof LivingEntity living) {
            ...
            if (stack.getItem() instanceof OdmAttachableAddonArmorItem item) {
                ItemStack sheath = item.getRightSheath(stack);
    ...
    public static class Serializer implements ITextureVariableSerializer {
        ...
        public ITextureVariable parse(JsonObject json) {
            return new OdmBladesRightTextureVariable();
        }

        @Override
        public void addDocumentationFields(JsonDocumentationBuilder builder) {
            builder.setTitle("ODM Blades Right");
        }

        @Override
        public String getDocumentationDescription() {
            return "Returns the amount of blades in the entity's right ODM sheath";
        }

        @Override
        public ResourceLocation getId() {
            return SubjectsOfYmir.rsrc("odm_blades_right");
        }
    }
}
