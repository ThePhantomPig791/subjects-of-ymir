...
import net.phantompig.soy.client.renderer.ShiftingRenderLayer;
...
public class SubjectsOfYmirClient {
    public static void init() {
        ...
        PackRenderLayerManager.registerParser(SubjectsOfYmir.rsrc("shifting"), ShiftingRenderLayer::parse);
