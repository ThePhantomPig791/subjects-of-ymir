...
import net.phantompig.soy.client.animation.*;
...
public class SubjectsOfYmirClient {
    public static void init() {
        ...
        PalladiumClientEvents.REGISTER_ANIMATIONS.register(registry -> {
            ...
            registry.accept(SubjectsOfYmir.rsrc("eat"), EatAnimation.INSTANCE);
        });
        ...
        OverlayRegistry.registerOverlay(SubjectsOfYmir.MOD_ID + "/other_shifting", SoyOverlays::renderOtherShiftingOverlay);
