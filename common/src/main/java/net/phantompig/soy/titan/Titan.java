...
public class Titan {
    ...
    private Titan(ResourceLocation id, List<String> variants, int health, float scale, int maxProgress, int maxCharge, float speed, float jump) {
        this.id = id;
    ...
    public static class TitanBuilder {
        ...
        public Titan create() {
            return new Titan(id, variants, health, scale, maxProgress, maxCharge, speed, jump);
        }
    }
}
