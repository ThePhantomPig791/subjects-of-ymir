...
public class TitanMemoryManager {
    ...
    static {
        ...
        ANCIENT_MESSAGES.add("Those Subjects... devils...");
        ...
        ANCIENT_MESSAGES.add("Only 13 years... only 13 lives...");
        ...
        ANCIENT_MESSAGES.add("Your party of none");
        ANCIENT_MESSAGES.add("My corpse...");
        ...
        ANCIENT_MESSAGES.add("Visit the basement, learn the secrets.");
        ...
        ANCIENT_MESSAGES.add("Titan fodder. All of them.");
        ANCIENT_MESSAGES.add("See your future.");
