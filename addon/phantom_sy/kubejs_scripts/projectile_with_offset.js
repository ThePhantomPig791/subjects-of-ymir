...
StartupEvents.registry('palladium:abilities', event => {
    event.create('phantom_sy:projectile_with_offset')
            ...
            if (enabled) {
                ...
                for (let i = 0; i < COUNT; i++) {
                    ...
                    if (!ALIGN_VEL_WITH_CALC_ROT) {
                        ...
                        // don't ask me why pitch is first here instead of yaw
                        // and also don't ask me why they're negative this is just what works
